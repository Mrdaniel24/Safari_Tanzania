...
if ($q !== '') {
    $where[] = "(a.name LIKE :q OR a.location LIKE :q OR a.description LIKE :q)";
    $params[':q'] = "%$q%";
}
if ($region !== '') {
...
<title>Exclusive Accommodations — SAFARI TANZANIA</title>
...
<section class="max-w-7xl mx-auto px-6 py-12">
  ...
  <?php elseif ($view === 'map'): ?>
    ...
    <p class="text-xs text-stone-400 text-center">
      Map data © <a href="https://www.openstreetmap.org/copyright" target="_blank" class="hover:underline">OpenStreetMap</a> contributors.
        ...
        <article class="group bg-white rounded-2xl overflow-hidden border border-stone-100 hover:shadow-xl transition">
          ...
          <div class="p-5">
            ...
            <p class="text-sm text-stone-600 mt-3 line-clamp-2">
              <?= e(mb_strimwidth((string)($a['description'] ?? ''), 0, 120, '…')) ?>
            </p>
